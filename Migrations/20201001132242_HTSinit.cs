...
{
    public partial class HTSinit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedDate = table.Column<DateTimeOffset>(nullable: false),
                    Edited = table.Column<bool>(nullable: false),
                    NameofSite = table.Column<string>(nullable: true),
                    OutreachName = table.Column<string>(nullable: true),
                    ...
                    ResultPositiveType = table.Column<int>(nullable: false),
                    Receivedresult = table.Column<int>(nullable: false),
                    Noofmalecondomsissued = table.Column<long>(nullable: true),
                    Nooffemalecondomsissued = table.Column<long>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HTS", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShehiaName = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_shehia", x => x.ID);
                    table.ForeignKey(
                        name: "FK_shehia_district_districtId",
